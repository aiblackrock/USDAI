 ...
 */
contract DeployChainlinkCCIPTellerScript is Script, ContractNames, MinatoAddresses, MerkleTreeHelper {
    ...
    function setUp() external {
        ...
        boringVault = deployer.getAddress(UsdaiMinatoVaultName);
        accountant = deployer.getAddress(UsdaiMinatoVaultAccountantName);
    ...
    function run() external {
        ...
        chainlinkCCIPTeller = ChainlinkCCIPTeller(
            deployer.deployContract(UsdaiMinatoChainlinkCCIPTellerName, creationCode, constructorArgs, 0)
        );
