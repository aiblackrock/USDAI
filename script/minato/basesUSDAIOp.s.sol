...
contract BasesUSDAIOp is Script, MinatoAddresses, MerkleTreeHelper, ContractNames {
    ...
    function run() public {
        ...
        setAddress(true, minato, "boringVault", deployer.getAddress(sUsdaiVaultName));
        setAddress(true, minato, "managerAddress", deployer.getAddress(sUsdaiVaultManagerName));
        setAddress(true, minato, "accountantAddress", deployer.getAddress(sUsdaiVaultAccountantName));
        setAddress(true, minato, "rawDataDecoderAndSanitizer", deployer.getAddress(UsdaiBaseDecoderAndSanitizerName));
