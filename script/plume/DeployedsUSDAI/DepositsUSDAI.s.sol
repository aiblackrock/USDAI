 ...
 */
contract sUSDAIDepositScript is Script, PlumeAddresses, ContractNames, MerkleTreeHelper {
    // Test parameters
    uint256 public constant USDAI_DEPOSIT_AMOUNT = 2 * 1e6; // 20 USDAI (6 decimals)
