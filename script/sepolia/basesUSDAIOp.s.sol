...
contract BasesUSDAIOp is Script, SepoliaAddresses, MerkleTreeHelper, ContractNames {
    ...
    function run() public {
        ...
        setAddress(true, sepolia, "boringVault", deployer.getAddress(sUsdaiVaultName));
        setAddress(true, sepolia, "managerAddress", deployer.getAddress(sUsdaiVaultManagerName));
        setAddress(true, sepolia, "accountantAddress", deployer.getAddress(sUsdaiVaultAccountantName));
        setAddress(true, sepolia, "rawDataDecoderAndSanitizer", deployer.getAddress(UsdaiBaseDecoderAndSanitizerName));
