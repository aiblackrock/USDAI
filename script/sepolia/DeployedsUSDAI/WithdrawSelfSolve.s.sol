 ...
 * @notice This script demonstrates how to withdraw sUSDAI from the sUSDAI vault on Sepolia using the BoringQueue
 * @dev Run with: forge script script/DeployedUSDAI/Sepolia/Withdraw.s.sol --rpc-url $SEPOLIA_RPC_URL
 */
contract sUSDAISelfSolveScript is Script, SepoliaAddresses, ContractNames, MerkleTreeHelper {
    // Contract instances
    ...
    function run() public {
        ...
        // uint256 USDAI_DEPOSIT_AMOUNT = 2 * 1e6;
