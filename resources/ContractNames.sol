...
contract ContractNames {
    ...
    string public constant UsdaiBoringOnChainQueuesRolesAuthorityName = "SuperUSD Boring OnChain Queues Roles Authority V0.2";
    string public constant UsdaiVaultRolesAuthorityName = "SuperUSD Vault RolesAuthority V0.2";
    string public constant UsdaiArcticArchitectureLensName = "SuperUSD Arctic Architecture Lens V0.2";
    string public constant UsdaiVaultName = "SuperUSD Vault V0.2";
    string public constant UsdaiVaultManagerName = "SuperUSD Vault Manager With Merkle Verification V0.2";
    string public constant UsdaiVaultAccountantName = "SuperUSD Vault Accountant With Rate Providers V0.2";
    string public constant UsdaiVaultTellerName = "SuperUSD Vault Teller With Multi Asset Support V0.2";
    string public constant UsdaiVaultDecoderAndSanitizerName = "SuperUSD Vault Decoder and Sanitizer V0.2";
    string public constant UsdaiVaultDelayedWithdrawer = "SuperUSD Vault Delayed Withdrawer V0.2";
    ...
    string public constant UsdaiLayerZeroTellerName = "SuperUSD LayerZero Teller V0.2";
    string public constant UsdaiChainlinkCCIPTellerName = "SuperUSD Chainlink CCIP Teller V0.2";
    string public constant UsdaiAcrossDecoderAndSanitizerName = "SuperUSD Across Decoder and Sanitizer V0.2";
    string public constant UsdaiMorphoDecoderAndSanitizerName = "SuperUSD Morpho Decoder and Sanitizer V0.2";
    string public constant UsdaiOpenEdenDecoderAndSanitizerName = "SuperUSD OpenEden Decoder and Sanitizer V0.2";
    string public constant UsdaiKyoDecoderAndSanitizerName = "SuperUSD Kyo Decoder and Sanitizer V0.2";

    // sUSDAI 
    string public constant sUsdaiBoringOnChainQueuesRolesAuthorityName = "sSuperUSD Boring OnChain Queues Roles Authority V0.2";
    string public constant sUsdaiVaultRolesAuthorityName = "sSuperUSD Vault RolesAuthority V0.2";
    string public constant sUsdaiArcticArchitectureLensName = "sSuperUSD Arctic Architecture Lens V0.2";
    string public constant sUsdaiVaultName = "sSuperUSD Vault V0.2";
    string public constant sUsdaiVaultManagerName = "sSuperUSD Vault Manager With Merkle Verification V0.2";
    string public constant sUsdaiVaultAccountantName = "sSuperUSD Vault Accountant With Rate Providers V0.2";
    string public constant sUsdaiVaultTellerName = "sSuperUSD Vault Teller With Multi Asset Support V0.2";
    string public constant sUsdaiVaultDecoderAndSanitizerName = "sSuperUSD Vault Decoder and Sanitizer V0.2";
    string public constant sUsdaiVaultDelayedWithdrawer = "sSuperUSD Vault Delayed Withdrawer V0.2";
    ...
    string public constant sUsdaiLayerZeroTellerName = "sSuperUSD LayerZero Teller V0.2";
    string public constant sUsdaiChainlinkCCIPTellerName = "sSuperUSD Chainlink CCIP Teller V0.2";
}
